                          ...
                          >
                            ...
                            <td className="px-4 py-6 text-sm text-slate-600">
                              <div className="space-y-1">
                                ...
                                <p>
                                  Mileage: {v.milage?.toLocaleString() ?? "—"}{" "}
                                  km · Location: {v.location || "—"}
                                </p>
                                <p>
                                  Condition: {v.car_condition || "—"} · Price:{" "}
                                  {v.price
                                    ? `${v.price} ${v.currency || "EGP"}`
                                    : "—"}
                                </p>
                              </div>
                            </td>
                                ...
                                <td className="px-4 py-6">
                                  <select
                                    ...
                                    onChange={async (e) => {
                                      ...
                                      if (result.ok) {
                                        const data =
                                          await getPendingKYC(effectiveToken);
                                        setKycDocuments(data || []);
                                      } else {
                                        alert(
                                          result.message ||
                                  ...
                                  <button
                                    ...
                                    onClick={async () => {
                                      ...
                                      try {
                                        ...
                                        const userDetails = await viewuser(
                                          userId,
                                          effectiveToken,
                                        );
                                        console.log(
                                    ...
                                    onChange={async (e) => {
                                      ...
                                      try {
                                        ...
                                        if (res.ok) {
                                          ...
                                          let data;
                                          if (auctionSearch.trim()) {
                                            data = await searchAuctions(
                                              auctionSearch.trim(),
                                              effectiveToken,
                                            );
                                          } else if (auctionStatusFilter) {
                                            data = await filterAuctions(
                                              auctionStatusFilter,
                                              effectiveToken,
                                            );
                                          } else {
          ...
          <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50 overflow-y-auto">
            <div className="bg-white rounded-3xl shadow-2xl w-full max-w-4xl my-8">
              ...
              <div className="sticky top-0 px-8 py-6 bg-gradient-to-r from-indigo-600 to-purple-600 flex items-center justify-between rounded-t-3xl">
                <div>
                  <p className="text-xs text-indigo-100 font-bold uppercase tracking-widest mb-1">
                    Auction Details
                  </p>
              ...
              <div className="overflow-y-auto max-h-[calc(100vh-200px)] p-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                  ...
                  <div className="bg-white rounded-xl p-5 border border-slate-200 shadow-sm">
                    ...
                    <span
                      className={`inline-flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-bold uppercase tracking-wider shadow-sm ${
                ...
                <div className="bg-gradient-to-br from-slate-50 to-slate-100 rounded-2xl p-6 border border-slate-200 mb-6">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="bg-white rounded-xl p-4 border border-slate-200">
                      ...
                      <div className="flex items-center gap-2">
                        <div
                          className={`w-3 h-3 rounded-full ${selectedAuction.autoExtendEnabled ? "bg-emerald-500" : "bg-slate-300"}`}
                        ></div>
              ...
              <div className="overflow-y-auto max-h-[calc(100vh-200px)] p-8">
                    ...
                    <img
                      ...
                      onError={(e) => {
                        ...
                        (
                          ...
                          `<div class="w-32 h-32 rounded-full bg-gradient-to-br from-indigo-400 to-purple-500 flex items-center justify-center text-white text-4xl font-black shadow-lg">${selectedKYC.firstName?.[0] || "U"}${selectedKYC.lastName?.[0] || ""}</div>`;
                      }}
                    />
                  ) : (
                    ...
                    <div className="bg-white rounded-xl p-4 border border-slate-200">
                      ...
                      <span
                        className={`inline-block px-3 py-1 rounded-lg text-xs font-bold uppercase tracking-wider ${
                          selectedKYC.role === "admin"
                            ? "bg-purple-100 text-purple-700"
                            : selectedKYC.role === "seller"
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      <div
                        className={`w-3 h-3 rounded-full ${selectedKYC.isActive ? "bg-emerald-500" : "bg-slate-400"}`}
                      ></div>
                      <p
                        className={`text-lg font-bold ${selectedKYC.isActive ? "text-emerald-700" : "text-slate-700"}`}
                      >
                  ...
                  >
                    ...
                    <span
                      className={`inline-flex items-center gap-2 px-3 py-1 rounded-lg text-sm font-bold uppercase ${
                        selectedKYC.kycStatus === "approved"
                          ? "bg-emerald-500 text-white"
                          : selectedKYC.kycStatus === "rejected"
                            ? "bg-rose-500 text-white"
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      <div
                        className={`w-3 h-3 rounded-full ${selectedKYC.isBanned ? "bg-rose-500" : "bg-emerald-500"}`}
                      ></div>
                      <p
                        className={`text-lg font-bold ${selectedKYC.isBanned ? "text-rose-700" : "text-emerald-700"}`}
                      >
                ...
                {selectedKYC.isBanned && selectedKYC.banreason && (
                  <div className="mb-8 bg-rose-50 rounded-xl p-6 border border-rose-200">
                    <h4 className="text-sm font-bold text-rose-700 uppercase tracking-widest mb-3">
                      Ban Reason
                    </h4>
