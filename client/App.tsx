...
import { Home, Search, PlusCircle, User, Bell, Shield, LayoutDashboard, Menu, X, LogOut, ChevronRight, Car } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  const navigation = [
    { name: 'Browse', href: '/', icon: Home, roles: [UserRole.GUEST, UserRole.BUYER, UserRole.SELLER, UserRole.ADMIN] },
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
              ...
              <div>
                ...
                <ul className="space-y-3 text-sm">
                  <li><Link to="/" className="hover:text-indigo-400">All Auctions</Link></li>
                  <li><Link to="/" className="hover:text-indigo-400">Past Results</Link></li>
                  <li><Link to="/" className="hover:text-indigo-400">How it Works</Link></li>
                </ul>
              </div>
              <div>
                ...
                <ul className="space-y-3 text-sm">
                  ...
                  <li><Link to="/" className="hover:text-indigo-400">Buyer Protections</Link></li>
                </ul>
              </div>
              <div>
                ...
                <ul className="space-y-3 text-sm">
                  ...
                  <li><Link to="/" className="hover:text-indigo-400">Cookie Policy</Link></li>
                </ul>
              </div>
            </div>
